...
/**
 * Provides filtering for Recipient level servlets
 * @author Alex Hill
 */
public class RecipientFilter implements Filter
{
    ...
    /**
     * Contains the logic for executing the function of the filter. In this case making sure the logged in user is a Recipient.
     * @param request
     * @param response
     * @param chain
     * @throws IOException
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException
    {
        ...
        if (!AccountService.userIsRecipient(username))
        {
            ...
            {
                httpResponse.sendRedirect("../ViewReport");
                return;
            }
            else
            {
