...
/**
 * Provides filtering for Reporter level servlets
 * @author Alex Hill
 */
public class ReporterFilter implements Filter
{
    ...
    /**
     * Contains the logic for executing the function of the filter. In this case making sure the logged in user is a Reporter.
     * @param request
     * @param response
     * @param chain
     * @throws IOException
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException
    {
        ...
        if (!AccountService.userIsReporter(username))
        {
            ...
            {
                httpResponse.sendRedirect("../dataEntry");
                return;
            }
            else
            {
